...
extension AppDelegate {
    ...
    func getCurrentLocation() -> (Double, Double) {
        ...
        if(CLLocationManager.authorizationStatus() == .authorizedWhenInUse ||
           CLLocationManager.authorizationStatus() == .authorizedAlways) {
            ...
            latitude = Double(currentLoc.coordinate.latitude)
            longitude = Double(currentLoc.coordinate.longitude)
    ...
    func getAddressFromLatLon(latitude: Double, longitude: Double, completion: @escaping (_ address: String)-> Void) {
