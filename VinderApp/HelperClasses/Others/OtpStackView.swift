...
class OTPStackView: UIStackView {
    ...
    //Colors
    let inactiveFieldBorderColor = UIColor.lightGray // UIColor(white: 1, alpha: 0.3)
    let textBackgroundColor = UIColor(white: 1, alpha: 0.5)
    let activeFieldBorderColor = UIColor.darkGray
...
//        textField.heightAnchor.constraint(equalTo: self.heightAnchor).isActive = true
        ...
        textField.font = UIFont(name: "poppins", size: 24)
